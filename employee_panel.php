...
<body>
    ...
    <section class="admin-dashboard">
        ...
        <div class = "box-container">
            <div class="box">
                    <?php 
                        $select_users = mysqli_query($conn, "SELECT * FROM `employee` WHERE user_type = 'employee' ")
                            or die('query failed');
            ...
            <div class="box">
                    <?php 
                        $select_users = mysqli_query($conn, "SELECT * FROM `client`")
                            or die('query failed');
                        $num_of_users = mysqli_num_rows($select_users);
                ...
                <div class="box">
                    <?php 
                        $select_users = mysqli_query($conn, "SELECT * FROM `deals`")
                            or die('query failed');
                        $num_of_users = mysqli_num_rows($select_users);
                ...
                <div class="box">
                    <?php 
                        $select_users = mysqli_query($conn, "SELECT * FROM `deals`WHERE dealLost = '0'")
                            or die('query failed');
                        $num_of_users = mysqli_num_rows($select_users);
                ...
                <div class="box">
                    <?php 
                        $select_users = mysqli_query($conn, "SELECT * FROM `deals`WHERE dealWon = '0'")
                            or die('query failed');
                        $num_of_users = mysqli_num_rows($select_users);
                            
                    ?>
                    <h3><?php echo $num_of_users; ?></h3>
                    <p>total deals Lost</p>
                </div>

                <div class="box">
                    <?php 
                        $select_users = mysqli_query($conn, "SELECT * FROM `product`")
                            or die('query failed');
                        $num_of_users = mysqli_num_rows($select_users);
            ...
            <div class="box">
                <?php 
                    $total_completes = 0;
                    $select_completes = mysqli_query($conn, "SELECT * FROM `deals` WHERE dealWon >=0")
                        or die('query failed');
                        while($fetch_completes = mysqli_fetch_assoc($select_completes)){
                            $total_completes += $fetch_completes['dealWon'];
                        }
                ?>
