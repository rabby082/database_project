<?php
    ...
    if(isset($_POST['updte_product'])){
        ...
        $update_image_tmp_name = $_FILES['update_image']['temp_name'];
        ...
        $update_query = mysqli_query($conn, "UPDATE `products` SET `id`='$update_id',`name`='$update_name',`price`='$update_price',
            `product_detail`='$update_detail' WHERE id='$update_id'")or die('query failed');
        }
        if($update_query){
    ...
    <section class="form-container1">
        <div class="box-container">
            ...
            <div class="box">
                ...
                <p>price: <?php echo $fetch_products['price']; ?> Taka</p>
