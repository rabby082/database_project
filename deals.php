...
<body>
    <?php include 'employee_header.php'; ?>
        ...
        <a href="employee_panel.php" class="logo"><img class="transparent-logo1" src="img/deals11.jpeg"></a>
        ...
        <form method="post" action="" enctype="multipart/form-data">
            <h1>create deals</h1>
                    <div class="input-field">
                        ...
                        <input type="number" min='0' name="clientid" required>
                    </div> 
                    <div class="input-field">
                        <label>title</label>
                    ...
                    <div class="input-field">
                        ...
                        <textarea name="analysis" required></textarea>
                    </div>
                    <div class="input-field">
    ...
    <section class="form-container1">
        <div class="box-container">
            <?php
                ...
                LEFT JOIN `client` ON deals.clientID = client.clientID
            ...
            <div class="box">
                ...
                <a href="deals.php?client=<?php echo $fetch_products['clientID']; ?>"class="deals">client profile</a><br>
                <a href="dealsproduct.php?product=<?php echo $fetch_products['dealsID']; ?>"class="product">Insert Product</a>
