<?php
     ...
     if(isset($_POST['submit-btn'])){
        ...
        $select_user = mysqli_query($conn, "SELECT * FROM employee WHERE email = '$email'") or die('die Asik');
        ...
        if(mysqli_num_rows($select_user)>0){
            ...
            if($row['user_type']=='admin'){
                ...
                $_SESSION['employee_name'] = $row['firstName'];
...
<body>
    ...
    <section class="form-container">
        ...
        <form method="post">
            ...
            <p>do not have an account ? <a href="employee.php">register now</p>
        </form>
